...
/* ==========================================
   6. FUNÇÕES DE NAVEGAÇÃO DE IMAGENS
   ========================================== */
...
// CRIA IMAGEM COM CONTROLES E BOTÃO DE EXPANSÃO
...
/* ==========================================
   7. FUNÇÕES DE RENDERIZAÇÃO DE FILMES E CARDS
   ========================================== */
...
function renderFilms() {
    ...
    filmsToShow.forEach(film => {
        ...
        // Cria e adiciona o poster com controles
        const posterComponent = createSmartPoster(film);
        filmCard.appendChild(posterComponent);
        ...
        // Adiciona evento de clique para abrir o modal do filme
...
/* ==========================================
   8. FUNÇÕES DE ZOOM E MODAL DA CAPA
   ========================================== */
...
// RENDERIZAÇÃO DOS PLANOS DE AULA
...
// RENDERIZAÇÃO DE OUTROS MATERIAIS
...
function openModal(film) {
    ...
    modalContent.innerHTML = `
        ...
        <div class="modal-additional">
            ...
            ${film.portaCurta ? `<p><strong><i class="fas fa-film"></i> Porta Curtas:</strong> <a href="${film.portaCurta}" target="_blank">${film.portaCurta}</a></p>` : ''}
        ...
        <div class="modal-teaching-plans">
            ...
            <a href="https://docs.google.com/forms/d/e/1FAIpQLSdxQz8onMOFjxIqEPpo5v2I4CJdLQ9cN50I7zUhmnBwgUeGIQ/viewform" target="_blank" class="submit-plan-button">
...
/* ==========================================
   10. FUNÇÕES DE CONTROLE DE MODAL
   ========================================== */
